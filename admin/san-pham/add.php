          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-6 col-md-offset-3">
                <img name="image" id="imageTarget" src="<?= $siteUrl?>img/default/default.png" class="img-responsive" required>
              </div>
            </div>
            <div class="form-group">
              <b>Ảnh sản phẩm</b>
        ...
        $("#demoForm").validate({
            ...
            messages: {
                ...
                "sell_price":{
                    ...
                    number: "<p class='mb-0' style='color: red;'>Nhập số</p>",
                    minlength: "'sell_price' < list_price",
                },
                "image": {
                    required: "<p class='mb-0' style='color: red;'>Chọn ảnh sản phẩm</p>"
                },
                "cate_id":{
