...
$db = mysqli_connect('localhost', 'root', '', 'sportshop');
// REGISTER USER
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    header('location: http://localhost/sportshop/index.php');
  }
}
...
if (isset($_POST['login_user'])) {
  ...
  if (count($errors) == 0) {
    ...
    if (mysqli_num_rows($results) == 1) {
      $_SESSION['username'] = $username;
      $_SESSION['success'] = "";
      header('location: http://localhost/sportshop/khach-hang/index.php');
    }else {
